...
{
	static const int        cScreenWidth = 640;//320;
	static const int        cScreenHeight = 480;//240;
...
private:
    ...
    void                    DrawSkeleton(const NUI_SKELETON_DATA & skel, int skel_id, int windowWidth, int windowHeight);
